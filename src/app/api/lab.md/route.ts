...
export async function GET() {
  // The local replica reads the public CMS at request time. Keeping this route
  // out of prerendering prevents a slow external request from blocking the
  // otherwise static site build.
  await connection()
