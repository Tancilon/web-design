...
const TweetFallback = ({ id }: CustomTweetProps) => (
  <div className="dark mx-auto grid w-full max-w-[500px] place-items-center rounded-lg border border-brand-g2 bg-brand-k p-6 text-center">
    <p className="text-brand-w2">External post</p>
    <a
      className="mt-2 text-sm text-brand-g1 underline underline-offset-4"
...
export const CustomTweet = async ({ id }: CustomTweetProps) => {
  ...
  if (process.env.LOCAL_REPLICA_SKIP_EXTERNAL_EMBEDS === "1") {
